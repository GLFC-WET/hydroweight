...
* [3.0 Inverse distance-weighted rasters using `hydroweight()`](#30-inverse-distance-weighted-rasters-using-hydroweight)
  ...
  + [3.5 Using `hydroweight()` iFLO output as subsequent catchment boundaries](#35-using-hydroweight-iFLO-output-as-subsequent-catchment-boundaries)
Using `hydroweight()` iFLS outputs subsequent catchment boundaries
