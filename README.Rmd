...
* [4.0 Inverse distance-weighted rasters using `hydroweight_attributes()`](#40-inverse-distance-weighted-attributes-using-hydroweight-attributes)
  + [4.1 Using numeric raster layer of interest](#41-using-numeric-raster-layer-of-interest)
