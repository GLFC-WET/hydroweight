...
plot(hw_test_1[[1]], main = "Lumped", axes = F, legend = F, col = viridis(101)[101],mar=NA)
plot(hw_test_1[[2]], main = "iEucO", axes = F, legend = F,  col = viridis(101),mar=NA)
plot(hw_test_1[[3]], main = "iFLO", axes = F, legend = F,  col = viridis(101),mar=NA)
plot(log(hw_test_1[[4]]), main = "HAiFLO", axes = F, legend = F,  col = viridis(101),mar=NA)
#plot.new()
plot(hw_test_1[[5]], main = "iEucS", axes = F, legend = F,  col = viridis(101),mar=NA)
plot(hw_test_1[[6]], main = "iFLS", axes = F, legend = F,  col = viridis(101),mar=NA)
plot(log(hw_test_1[[7]]), main = "HAiFLS", axes = F, legend = F, col = viridis(101),mar=NA)
```
...
plot(hw_test_1[[1]], main = "iEucO - 8000 m clip", axes = FALSE, legend = FALSE, col = viridis(101))
plot(hw_test_4[[2]], add = TRUE, axes = FALSE, legend = FALSE, col = viridis(101))
```
...
sites_attributes_products <- foreach(xx = 1:nrow(tg_O_multi), .errorhandling = "pass") %do% {
  ...
  sel_layers_hwa <- foreach(yy = 1:length(loi_variable), .errorhandling = "pass") %do% {
    ...
    loi_output <- do.call(hydroweight_attributes, loi_combined)
